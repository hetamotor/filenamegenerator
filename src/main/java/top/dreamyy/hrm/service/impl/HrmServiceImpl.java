...
public class HrmServiceImpl implements HrmService {
    ...
    /*======================= 部门接口实现 =======================*/
    /** HrmServiceImpl接口findAllDept方法实现 */
    @Transactional(readOnly = true)
    @Override
    ...
    @Override
    public void modifyJob(Job job) { jobDao.update(job); }

    /*======================= 公告接口实现 =======================*/
    /**
     * HrmService接口findNotice方法实现
     */
    @Transactional(readOnly = true)
    @Override
    ...
    @Override
    public String findMaxDocumentByTitle(String title) { return documentDao.selectMaxFilenameByTitle(title); }
